        ...
        <div
          ...
          <div>
            <a
              ...
              data-package-type="basic">Submit Tool</a>
          </div>
        </div>
        <div
          class="border border-[#e0e0e0] flex flex-col gap-2 rounded-lg h-[305px] bg-white shadow-md p-[32px] transition-all duration-300 transform hover:-translate-y-2 hover:shadow-lg">
          ...
          <div>
            <a
              href="#"
              class="bg-[var(--primary)] relative rounded-md text-base top-[20px] text-white px-[24px] py-[12px] submit-tool-btn"
              data-package-type="premium">Get Started</a>
          </div>
        </div>
        <div
          class=" w-full border-2 border-[var(--primary)] relative flex flex-col gap-2 rounded-lg h-auto min-h-[400px] bg-white shadow-md p-[32px] transition-all duration-300 transform hover:-translate-y-2 hover:shadow-lg">
          <div class="absolute top-0 right-0 bg-[var(--primary)] text-white text-xs font-bold px-3 py-1 rounded-bl-lg">MOST POPULAR</div>
          <h3 class="text-[var(--primary)] text-[1.8rem] font-semibold">Ultimate Exposure Package</h3>
          <p class="text-[1.4rem] text-[#333333]">$999 <span class="text-sm">(Full Visibility + Social Shoutouts)</span></p>
          <p class="text-[#666666] italic mb-2">"Maximum visibility. Maximum credibility. Maximum leads."</p>
          <ul class="flex flex-col gap-1">
            <li class="text-[#28a745] flex items-start gap-2">
              <i class="fa-solid fa-check-circle mt-1"></i>
              <p class="text-[#555555]">Everything in Premium, plus:</p>
            </li>
            <li class="text-[#28a745] flex items-start gap-2">
              <i class="fa-solid fa-check-circle mt-1"></i>
              <p class="text-[#555555]">Dedicated social media shoutout on Twitter/X & LinkedIn</p>
            </li>
            <li class="text-[#28a745] flex items-start gap-2">
              <i class="fa-solid fa-check-circle mt-1"></i>
              <p class="text-[#555555]">Mini feature post on our blog (SEO-optimized)</p>
            </li>
            <li class="text-[#28a745] flex items-start gap-2">
              <i class="fa-solid fa-check-circle mt-1"></i>
              <p class="text-[#555555]">Priority placement in multiple categories (if relevant)</p>
            </li>
            <li class="text-[#28a745] flex items-start gap-2">
              <i class="fa-solid fa-check-circle mt-1"></i>
              <p class="text-[#555555]">Featured in a "Top AI Marketing Tools" curated list (where applicable)</p>
            </li>
            <li class="text-[#28a745] flex items-start gap-2">
              <i class="fa-solid fa-check-circle mt-1"></i>
              <p class="text-[#555555]">Optional affiliate partnership promotion (if available)</p>
            </li>
            <div>
              <a
                href="#"
                class="bg-[var(--primary)] relative rounded-md text-base top-[20px] text-white px-[24px] py-[12px] submit-tool-btn"
                data-package-type="ultimate">Get Maximum Exposure</a>
            </div>
        </div>
      </div>
    </div>
