...
<section class="px-3 sm:px-5 py-[80px] flex flex-col gap-5 max-w-[1440px] mx-auto"  data-aos-delay="100">
    ...
    <div class="services-boxes grid sm:grid-cols-2 xl:grid-cols-4 justify-between gap-5">
      <div class="bg-[#EAEFFF70]   basis-[25%] text-white h-[300px] flex flex-col justify-between rounded-xl p-4" data-aos="zoom-in" data-aos-delay="100">
        <div>
      ...
      <div
        class="bg-[#EAEFFF70]   basis-[25%] text-white h-[300px] flex flex-col justify-between rounded-xl p-4" data-aos="zoom-in" data-aos-delay="200">
        <div>
      ...
      <div
        class="bg-[#EAEFFF70]   basis-[25%]  text-white h-[300px] flex flex-col justify-between rounded-xl p-4" data-aos="zoom-in" data-aos-delay="300">
        <div>
      ...
      <div
        class="basis-[25%] bg-[#EAEFFF70]    text-white h-[300px] flex flex-col justify-between rounded-xl p-4" data-aos="zoom-in" data-aos-delay="400">
        <div>
