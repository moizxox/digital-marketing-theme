  ...
  <section class="max-w-[1440px] mx-auto">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
      <div class="flex items-center gap-2">
        ...
        <span class="bg-[#FFCC00] text-[var(--primary)] py-1 px-2 rounded-md text-[20px]"> <?php echo $services_count; ?> </span>
        <h1 class="text-[22px] sm:text-[40px] font-semibold">Digital Marketing <span class="text-[var(--primary)]">Services</span></h1>
      </div>
      <div class="flex justify-end">
        <a href="/services" class="bg-[var(--primary)] w-fit h-fit text-white py-2 px-3 sm:px-5 rounded-md">View All</a>
      </div>
    </div>
